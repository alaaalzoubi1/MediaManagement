...
public class MediaManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MediaManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
